...
export default function OnThisPageLinks({
  ...
  return (
    <div className="sticky inset-x-0 top-[88px] z-[11] block w-full bg-default px-4 pb-4 pt-2 lg:hidden">
      <Menu>
        {({ open }) => (
          <div className="relative w-full">
            <div className="">
              <Menu.Button className="text-md inline-flex cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-md border-2 bg-dnt-orange-200/50 px-3 py-2 font-medium hover:bg-dnt-orange-200/75 dark:border-dnt-orange-200/20 dark:bg-dnt-orange-200/10 dark:hover:border-dnt-orange-200/50">
                On this page
                <svg
            ...
            <Menu.Items
              dir="ltr"
              className="t3-scrollbar absolute top-full z-10 mt-3 max-h-[45vh] w-full overflow-y-auto rounded-md border-2 border-primary bg-default py-1.5 shadow-md dark:border-dnt-orange-200/20 dark:bg-default"
            >
                      ...
                      {({ active }) => (
                        <a
                          className={clsx(
                            ...
                            {
                              "bg-dnt-orange-300/20 text-dnt-orange-400 underline dark:bg-dnt-orange-300/10 dark:text-dnt-orange-100":
                                active,
